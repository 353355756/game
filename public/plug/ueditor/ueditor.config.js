...
(function () {
     ...
     */
    window.UEDITOR_HOME_URL = '/plug/ueditor/';
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:'http://www.91-edu.org/editorupload'//URL+"php/imageUp.php"             //图片上传提交地址
        ,imagePath:"http://www.91-edu.org/upload"//URL + "php/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
