...
( function() {
	...
	var that; 
	var cdn = '../../../../plug/mathjax/MathJax.js?config=MML_HTMLorMML-full';
	CKEDITOR.plugins.add( 'mathjaxWiris', {
		...
		init: function( editor ) {
			...
			editor.widgets.add( 'mathjaxWiris', {
				inline: true,
				dialog: 'mathjaxWiris',
				button: editor.lang.mathjaxWiris.button,
				mask: true,
				...
				pathName: editor.lang.mathjaxWiris.pathName,
		...
		CKEDITOR.plugins.mathjaxWiris.frameWrapper = function( iFrame, editor ) {
			...
			var buffer, preview, value, newValue,
				...
				updateDoneHandler = CKEDITOR.tools.addFunction( function() {
					CKEDITOR.plugins.mathjaxWiris.copyStyles( iFrame, preview );
			...
			function update() {
				...
				preview.setHtml( '<img src=' + CKEDITOR.plugins.mathjaxWiris.loadingIcon + ' alt=' + editor.lang.mathjaxWiris.loading + '>' );
		...
		CKEDITOR.plugins.mathjaxWiris.frameWrapper = function( iFrame, editor ) {
			...
			return {
				setValue: function( value ) {
					...
					CKEDITOR.plugins.mathjaxWiris.copyStyles( iFrame, tex );
	...
	CKEDITOR.plugins.mathjaxWiris.frameWiris = function( iFrame, editor ) {
			...
			doc.write( 
				...
				'<head>' +
					'<meta charset="utf-8">' +
					'<script src="../../../plug/wiris/wiris.js"></script>' +
